package com.foxestudo.crud.controller;

import com.foxestudo.crud.data.vo.ProdutoVO;
import com.foxestudo.crud.services.ProdutoService;
...
public class ProdutoController {
    ...
    public ResponseEntity<?> findById(@RequestParam(value = "page", defaultValue = "0") int page,
